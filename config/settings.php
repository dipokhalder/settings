...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here are each of the settings repositories setup. You can always implement
    | your own repository and configure it here.
    |
    */
    'repositories' => [
        'database' => [
            'handler' => Dipokhalder\Settings\Repositories\DatabaseRepository::class,
            'connection' => null,
            'table' => 'settings',
        ],
    ],
    ...
    */
    'casts' => [
        Carbon\Carbon::class => \Dipokhalder\Settings\Casts\CarbonCast::class,
        Carbon\CarbonPeriod::class => \Dipokhalder\Settings\Casts\CarbonPeriodCast::class,
    ],
