...
```bash
composer require dipokhalder/settings
```

Publish the config file with:

```bash
php artisan vendor:publish --provider="Dipokhalder\Settings\SettingsServiceProvider" --tag="config"
```

Publish the migration file with:

```bash
php artisan vendor:publish --provider="Dipokhalder\Settings\SettingsServiceProvider" --tag="migrations"
```
...
```php
use Dipokhalder\Settings\HasSettings;
...
```php
use Dipokhalder\Settings\Contracts\Castable;
